  ...
  <div class="login-card">
    ...
    <form method="POST" action="login_process.php" id="loginForm">
      <div class="input-group">
        ...
        <input name="email" type="email" id="emailInput" placeholder="Email address" required autocomplete="email">
      </div>
      <div class="input-group">
    ...
    <div class="signup-prompt">
      Don't have an account? <a href="register.php" id="signupRedirect">Join Glamour </a>
    </div>
  </div>
</div>
